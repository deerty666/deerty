document.addEventListener('DOMContentLoaded', () => {
    ...
    addButtons.forEach(button => {
        button.addEventListener('click', (e) => {
            ...
            let itemDescription = itemTitle; // الوصف الافتراضي
            ...
            if (radioGroupName) {
                // إذا كانت هناك خيارات (وجبات الدجاج واللحم)
                ...
                if (selectedRiceInput) {
                    ...
                    // نعتمد على تسمية خيار الأرز مباشرة
                    ...
                    itemDescription = itemTitle + " (إضافة " + optionLabel + ")";
                     ...
                     // إذا لم يتم اختيار أي خيار، نفترض الخيار الأساسي
                     itemDescription = itemTitle + " (رز شعبي)";
                }
            } else {
                // إذا كانت لا توجد خيارات (مثل المقبلات والمشروبات)

...
// عرض القائمة مع Accordion + مربعات ملونة
function renderMenu() {
...
function printReceipt() {
    let html = `
        <div style="width:80mm; margin:0 auto; padding:3mm 4mm 6mm 4mm; font-family:Arial,sans-serif; font-size:12.8px; line-height:1.4; direction:rtl; text-align:right;">
            
            <div style="text-align:center; margin-bottom:8px;">
                <img src="logo.png" style="width:100px; height:auto; margin-bottom:6px;">
                <h2 style="margin:4px 0; font-size:17px;">سحايب ديرتي</h2>
                <div style="border:2px solid #000; padding:6px; margin:8px 0; font-weight:bold; font-size:15px;">
                    فاتورة حجز مواقته
                </div>
                <p style="margin:4px 0;"><strong>رقم المطعم: 0112020203</strong></p>
                <p style="margin:3px 0; font-size:12px;">${new Date().toLocaleString('ar-SA')}</p>
                <hr style="border:1px dashed #000; margin:10px 0;">
            </div>

            <div style="font-size:12.5px; margin-bottom:10px;">
                <strong>اسم العميل:</strong> ${document.getElementById('custName').value || 'عميل'}<br>
                ...
                <strong>الموقع:</strong> ${document.getElementById('custAddress').value || 'غير محدد'}<br>
                <strong>نوع الطلب:</strong> ${orderType === 'delivery' ? 'توصيل' : 'استلام'}
            </div>
            <hr style="border:1px dashed #000; margin:8px 0 6px 0;">
    `;

    cart.forEach(item => {
        const total = item.price * item.qty;
        html += `
            <div style="margin:6px 0; border-bottom:1px dotted #000; padding-bottom:5px;">
    ...
    html += `
            <hr style="border:2px solid #000; margin:12px 0 8px 0;">

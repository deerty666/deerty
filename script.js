document.addEventListener('DOMContentLoaded', () => {
    ...
    // الدالة المسؤولة عن تحديث الرقم في زر السلة (تم تصحيحها)
    function updateCartDisplay() {
        viewCartBtn.textContent = `عرض السلة (${cartItems.length})`;
    }
    
    // يتم استدعاؤها لضبط العداد على (0) عند تحميل الصفحة لأول مرة (تم تصحيحها)
    updateCartDisplay(); 
    ...
    // ---------------------- 3. منطق توليد رسالة واتساب (محدثة لخيارات الطلب والتوصيل) ----------------------

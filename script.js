...
// عرض القائمة (مربعات ملونة + Accordion)
function renderMenu() {
...
// طباعة نهائية مضغوطة جداً
function printReceipt() {
let html = `
<div style="width:80mm; margin:0 auto; padding:2mm 3mm 4mm 3mm; font-family:Arial,sans-serif; font-size:12px; line-height:1.35; direction:rtl; text-align:right;">

<div style="text-align:center; margin-bottom:6px;">  
            <img src="logo.png" style="width:90px; height:auto; margin-bottom:5px;">  
            <h2 style="margin:3px 0; font-size:16px;">سحايب ديرتي</h2>  
            <div style="border:2px solid #000; padding:5px; margin:6px 0; font-weight:bold; font-size:14px;">  
                فاتورة حجز مواقته  
            </div>  
            <p style="margin:3px 0;"><strong>0112020203</strong></p>  
            <p style="margin:2px 0; font-size:11px;">${new Date().toLocaleString('ar-SA')}</p>  
        </div>  

        <div style="font-size:11.8px; margin-bottom:8px;">  
...
html += `  
        ...
        <div style="text-align:center; margin-top:10px; font-size:10.5px;">  
            شكراً لثقتكم 💙  
        </div>  
    </div>  
`;  

...
// ==================== طباعة محسنة ومضغوطة جداً ====================
function printReceipt() {
    let html = `
        <div style="width:80mm; margin:0 auto; padding:2mm 3mm 4mm 3mm; font-family:Arial,sans-serif; font-size:12px; line-height:1.3; direction:rtl; text-align:right;">
            
            <!-- رأس الفاتورة -->
            <div style="text-align:center; margin-bottom:6px;">
                <img src="logo.png" style="width:90px; height:auto; margin-bottom:4px;">

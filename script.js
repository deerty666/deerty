...
function printReceipt() {
    let html = `
        <div style="width:80mm; margin:0 auto; padding:4mm 5mm; font-family:Arial; font-size:12.8px; line-height:1.4; direction:rtl; text-align:right;">
            <div style="text-align:center; margin-bottom:8px;">
                <img src="logo.png" style="width:105px; height:auto; margin-bottom:6px;">
                <h2 style="margin:4px 0; font-size:17px;">سحايب ديرتي</h2>
                <div style="border:2px solid #000; padding:7px; margin:8px 0; font-weight:bold; font-size:15.5px;">
                    فاتورة حجز مواقته
                </div>
                <p style="margin:4px 0;"><strong>رقم المطعم: 0112020203</strong></p>
                <p style="margin:4px 0; font-size:12px;">${new Date().toLocaleString('ar-SA')}</p>
                <hr style="border:1px dashed #000; margin:10px 0;">
            </div>

            <div style="font-size:12.8px; margin-bottom:10px;">
    ...
    // الأصناف مع الأسعار والملاحظات
    cart.forEach(item => {
        const total = item.price * item.qty;
        html += `
            <div style="margin:7px 0; border-bottom:1px dotted #000; padding-bottom:5px;">
